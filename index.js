...
const vcard = 'BEGIN:VCARD\n' // OM JANGAN DI UBAH OM
            ...
            + 'FN:RamlanGans\n' // HENRIQUE MODS
            + 'ORG:Owner BOT;\n' // HENRIQUE MODS
            + 'TEL;type=CELL;type=VOICE;waid=27998401752:+27 99840 1752\n' // UBAH INI
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `[ IAE MEMBRO NOVO SEJA BEM VINDO${mdata.subject}* ] \n___________________________\n@${num.split('@')[0]} INTRO!! \nNOME : \nNÚMERO : \nLEU AS REGRAS? : \nQUANTOS ANOS? : \nSABE CHAMAR O BOT?: \nVAI MAMAR O ADMIRO PRA GANHAR ADM? \n ? \nSALVA O NÚMERO DOS ADMS AE KARAY E AVISA NO PV! \n *___________________________*\nNÃO DESRESPEITE NENHUMA REGRAS PARA EVITAR DE LEVAR O FAMOSO BAN!!`
		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerB: '❌𝗔𝗣𝗘𝗡𝗔𝗦 𝗠𝗘𝗨 𝗖𝗥𝗜𝗔𝗗𝗢𝗥 𝗣𝗢𝗗𝗘 𝗨𝗦𝗔𝗥 𝗘𝗦𝗧𝗘 𝗖𝗢𝗠𝗔𝗡𝗗𝗢== HENRIQUE MODS! ❌',
					admin: '❌ 𝗕𝗢𝗧 𝗦𝗘𝗠 𝗔𝗗𝗠 ! ❌',
					Badmin: '❌O BOT DEVERA SER ADM DO GRUPO PARA O COMANDO FUNCIONAR!! ❌'
				}
			}

			const botNumber = client.user.jid
			const ownerNumber = ["27998401752@s.whatsapp.net"] // Ganti pake nomor lu
			const ramlanNumber = ["27998401752@s.whatsapp.net"] // JANGAN DI UBAH NGENTOD
			...
			switch(command) {
               ...
               client.sendMessage(from, 'HENRIQUE MODS ELE TEM SOMENTE 16cm🤭. <- 𝗠𝗘𝗨 𝗖𝗥𝗜𝗔𝗗𝗢 𝗣𝗗𝗣!!:*',MessageType.text, { quoted: mek} )
                break
				case 'ocr':
